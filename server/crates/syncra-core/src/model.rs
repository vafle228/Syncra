...
pub enum SyncPhase {
    ...
    Searching,
    /// Идёт обмен с конкретным устройством.
    ///
    /// **Граница шага:** в S3 этой фазы не бывает — манифест и дифф едут в S4.
    Syncing,
...
pub struct SyncStatus {
    ...
    /// строки. Записи локальных секций сюда не попадают: им некуда ехать (§4.2).
