...
/**
 * Главный экран: список записей, поиск, группировка (F4, §3.1).
 *
 * ЗАКОН №1: на этом экране нет и не будет секретов — только `RecordMeta`.
 * Поиск идёт по метаданным; содержимое паролей и заметок не индексируется,
 * и это проговаривается пользователю в пустом состоянии поиска.
 *
 * Сайдбар секций — F7, карточка записи и reveal — F5.
 */
