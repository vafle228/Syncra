      ...
      <nav class="setup__steps" aria-label="Шаги создания хранилища">
        ...
        <span class="setup__steps-foot">
          ...
          <span class="setup__steps-hint">
            Перенос хранилища с другого устройства появится вместе с сопряжением по QR.
          </span>
        </span>
      </nav>
          ...
          <li class="setup__promise">
            ...
            <span>
              ...
              <span class="setup__promise-body">
                Сопряжение устройств появится в ближайших версиях: QR показывается локально и не
                требует интернета.
              </span>
            </span>
          </li>
